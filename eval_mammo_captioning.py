...
def main(_A: argparse.Namespace):
    ...
    for idx in range(len(val_dataset)):
        ...
        for image_id, caption, l_cc_img, l_mlo_img, r_cc_img, r_mlo_img in zip(
            ...
            cv2.putText(vis, predictions[-1]["image_path"], (10, vis.shape[0]-60), cv2.FONT_HERSHEY_SIMPLEX, 1, (255), 1, cv2.LINE_AA)
            cv2.putText(vis, 'Annotation - '+val_dataset[idx]["caption"], (10, vis.shape[0]-40), cv2.FONT_HERSHEY_SIMPLEX, 1, (255), 1, cv2.LINE_AA)
            cv2.putText(vis, 'Predictions - '+predictions[-1]["caption"], (10, vis.shape[0]-20), cv2.FONT_HERSHEY_SIMPLEX, 1, (255), 1, cv2.LINE_AA)
